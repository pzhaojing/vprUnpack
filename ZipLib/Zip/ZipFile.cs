	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		private long TestLocalHeader(ZipEntry entry, HeaderTest tests)
		{
			lock (baseStream_)
			{
				...
				if (signature != ZipConstants.LocalHeaderSignature && signature != ZipConstants.LocalHeaderSignature_VZ)
				{
		...
		*/
		...
		private void ReadEntries()
		{
			...
			else
			{
				...
				if (sig64 != ZipConstants.Zip64CentralFileHeaderSignature && sig64 != ZipConstants.Zip64CentralFileHeaderSignature_VZ)
				{
			...
			{
				uint temp = ReadLEUint();
				if (temp != ZipConstants.CentralHeaderSignature && temp != ZipConstants.CentralHeaderSignature_VZ)
				{
