...
namespace ICSharpCode.SharpZipLib.Zip
{
	...
	public static class ZipConstants
	{
		...
		public const int LocalHeaderSignature_VZ = 'V' | ('Z' << 8) | (3 << 16) | (4 << 24);
		...
		public const int LOCSIG_VZ = 'V' | ('Z' << 8) | (3 << 16) | (4 << 24);
		...
		public const int SpanningSignature_VZ = 'V' | ('Z' << 8) | (7 << 16) | (8 << 24);
		...
		public const int SPANNINGSIG_VZ = 'V' | ('Z' << 8) | (7 << 16) | (8 << 24);

		/// <summary>
		/// Signature for temporary spanning entry
		/// </summary>
		public const int SpanningTempSignature = 'P' | ('K' << 8) | ('0' << 16) | ('0' << 24);
		public const int SpanningTempSignature_VZ = 'V' | ('Z' << 8) | ('0' << 16) | ('0' << 24);
		...
		public const int SPANTEMPSIG_VZ = 'V' | ('Z' << 8) | ('0' << 16) | ('0' << 24);
		...
		public const int DataDescriptorSignature_VZ = 'V' | ('Z' << 8) | (7 << 16) | (8 << 24);
		...
		public const int EXTSIG_VZ = 'V' | ('Z' << 8) | (7 << 16) | (8 << 24);
		...
		public const int CENSIG_VZ = 'V' | ('Z' << 8) | (1 << 16) | (2 << 24);

		/// <summary>
		/// Signature for central header
		/// </summary>
		public const int CentralHeaderSignature = 'P' | ('K' << 8) | (1 << 16) | (2 << 24);
		public const int CentralHeaderSignature_VZ = 'V' | ('Z' << 8) | (1 << 16) | (2 << 24);

		/// <summary>
		/// Signature for Zip64 central file header
		/// </summary>
		public const int Zip64CentralFileHeaderSignature = 'P' | ('K' << 8) | (6 << 16) | (6 << 24);
		public const int Zip64CentralFileHeaderSignature_VZ = 'V' | ('Z' << 8) | (6 << 16) | (6 << 24);
		...
		public const int CENSIG64_VZ = 'V' | ('Z' << 8) | (6 << 16) | (6 << 24);

		/// <summary>
		/// Signature for Zip64 central directory locator
		/// </summary>
		public const int Zip64CentralDirLocatorSignature = 'P' | ('K' << 8) | (6 << 16) | (7 << 24);
		public const int Zip64CentralDirLocatorSignature_VZ = 'V' | ('Z' << 8) | (6 << 16) | (7 << 24);

		/// <summary>
		/// Signature for archive extra data signature (were headers are encrypted).
		/// </summary>
		public const int ArchiveExtraDataSignature = 'P' | ('K' << 8) | (6 << 16) | (7 << 24);
		public const int ArchiveExtraDataSignature_VZ = 'V' | ('Z' << 8) | (6 << 16) | (7 << 24);

		/// <summary>
		/// Central header digitial signature
		/// </summary>
		public const int CentralHeaderDigitalSignature = 'P' | ('K' << 8) | (5 << 16) | (5 << 24);
		public const int CentralHeaderDigitalSignature_VZ = 'V' | ('Z' << 8) | (5 << 16) | (5 << 24);
		...
		public const int CENDIGITALSIG_VZ = 'V' | ('Z' << 8) | (5 << 16) | (5 << 24);

		/// <summary>
		/// End of central directory record signature
		/// </summary>
		public const int EndOfCentralDirectorySignature = 'P' | ('K' << 8) | (5 << 16) | (6 << 24);
		public const int EndOfCentralDirectorySignature_VZ = 'V' | ('Z' << 8) | (5 << 16) | (6 << 24);
		...
		public const int ENDSIG_VZ = 'V' | ('Z' << 8) | (5 << 16) | (6 << 24);
